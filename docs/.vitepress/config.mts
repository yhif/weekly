...
export default defineConfig({
  ...
  head: [
    ...
    [
      'script',
      { async: '', src: 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2682010394958299', crossorigin: 'anonymous' }
    ]
  ],
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: '2024年七月',
        items: [
          { text: '周刊第 310 期', link: '/issue-310.md' },
          { text: '周刊第 309 期', link: '/issue-309.md' },
          { text: '周刊第 308 期', link: '/issue-308.md' },
